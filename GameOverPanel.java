...
public class GameOverPanel extends JPanel {
    ...
    public GameOverPanel(GameWindow menu, double currentScore) {
        ...
        JButton playAgainButton = createButton("src/play-again.png", "Play Again");
        playAgainButton.addActionListener(e -> handleButtonClick("Play Again"));

        // Create a Main Menu button
        JButton mainMenuButton = createButton("src/main-menu.png", "Main Menu");
    ...
    private void handleButtonClick(String buttonText) {
        if (buttonText.equals("Play Again")) {
            ...
            menu.revalidate();
            menu.repaint();
            menu.gamePanel.resetGame();
            menu.gamePanel.setGameOn(true);
            menu.gamePanel.setShieldOn(true);
            menu.gamePanel.setShieldVisible(true);
