...
class Projectile1 {
    ...
    public Projectile1(double x, double y, GamePanel gamePanel) {
        this.x = x;
        this.y = y;
...
class GamePanel extends JPanel {
    ...
    private boolean collisionDectection = true;
    private float alpha;
    ...
    private void spawnProjectiles() {
        ...
        // Spawn asteroids
        if (random.nextDouble() < (double) asteroidSpawnRate / 100) {
        ...
        // Spawn black holes
        if (random.nextDouble() < (double) blackHoleSpawnRate / 100) {
            double spawnX = panelWidth + 30;
            double spawnY = random.nextInt(panelHeight + 1);
        ...
        if (random.nextDouble() < (double) spaceCreatureSpawnRate / 100) {
            double spawnX = panelWidth + 30;
            double spawnY = random.nextInt(panelHeight + 1);
